    ...
    return (
        <div className="relative h-[400px] flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute flex justify-center items-center w-1/2 h-1/2">
                <div className="absolute  w-64 h-64 bg-red-900 rounded-full mix-blend-screen filter blur-xl opacity-80 animate-blob"></div>
                <div className="absolute top-5 w-64 h-64 bg-blue-900 rounded-full mix-blend-screen filter blur-xl opacity-80 animate-blob animation-delay-2000"></div>
                <div className="absolute right-32 w-64 h-64 bg-green-900 rounded-full mix-blend-screen filter blur-xl opacity-80 animate-blob animation-delay-6000"></div>
                <div className="absolute bottom-5 w-64 h-64 bg-purple-900 rounded-full mix-blend-screen filter blur-xl opacity-80 animate-blob animation-delay-2000"></div>
            </div>

            {/* Main Content */}
            <div className="relative z-10 flex flex-col items-center w-full text-center px-6 sm:px-16 text-white space-y-4">
                ...
                <div className=" flex items-center gap-5">
                    ...
                    <button className="overflow-hidden px-6 border rounded-md border-gray-500"
